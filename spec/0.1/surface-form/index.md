Status: NON-NORMATIVE (Historical; consolidated into codex-language-specification.md §8)
Lock State: UNLOCKED
Version: 0.1
...
The authoritative normative content is consolidated into `spec/0.1/codex-language-specification.md` §8.
